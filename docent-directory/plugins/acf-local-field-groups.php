...
acf_add_local_field_group(array(
	...
	'fields' => array(
		array(
			...
			'name' => 'photo',
			'type' => 'image',
			'instructions' => '<strong>Profile Photo Tips</strong>: Adding a photograph to your profile is a great way for us to connect with and recognize each other! For consistency, it\'s best if you choose a good quality, portrait-like photo that shows your head and shoulders. If you don\'t have a portrait, you may upload any photograph of yourself &ndash; just keep in mind that the website will automatically center, size and crop it to a vertical rectangular shape. If you do not add a photo of yourself,  a generic silhouette will be shown instead. To add your photo, click Browse and upload a photo from your computer. Your photo will show up once you click the Update Profile button at the bottom of this page. To change your photo, hover over the top right corner of your existing photo and choose the Edit icon (pencil) or Remove icon (X).',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
